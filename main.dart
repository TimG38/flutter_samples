...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _setPrimaryScrollController(BuildContext context) {
    if (_controller == null) {
      ...
      _controller.addListener(() {
        ...
        if (nestedPixel > 0) {
          ...
          print('nested=' + nestedPixel.toString());
        }
      });
    }
    return _controller;
    ...
    return Scaffold(
      body: Builder(builder: (BuildContext context) {
        return NestedScrollView(
            controller: _setPrimaryScrollController(context),
              ...
              child: NotificationListener<ScrollNotification>(
                ...
                onNotification: (ScrollNotification scrollInfo) {
                  ...
                  if (customPixel > 0) {
                    ...
                    print('custom=' + customPixel.toString());
                  }
                  return false;
                },
              ),
  ...
  _fabPrint(int value1, int value2) {
    setState(() {
      if (value1 != null) _offset1 = value1.toString();
      if (value2 != null) _offset2 = value2.toString();
    });
  }
}
